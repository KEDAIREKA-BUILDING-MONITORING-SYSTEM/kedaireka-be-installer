...
exports.findBuildingDetail = exports.findAllSetting = void 0;
...
const findAllSetting = async (req, res) => {
    try {
        ...
        const result = await settings_1.SettingsModel.findAndCountAll({
            where: {
                deleted: { [sequelize_1.Op.eq]: 0 },
                ...(Boolean(req.query.search) && {
                    [sequelize_1.Op.or]: [{ settingName: { [sequelize_1.Op.like]: `%${req.query.search}%` } }]
                })
            },
            order: [['id', 'desc']],
...
exports.findAllSetting = findAllSetting;
